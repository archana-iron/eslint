...
module.exports = {
    ...
    create(context) {
        ...
        // Function to check if the parameter has a default value
        function isDefaultParam(param) {
            return param.type === "AssignmentPattern";
        }

        /**
         * Decreases the complexity due to default parameters
         * @param {Array} params - Function parameters
         * @returns {number} - The number of default parameters
         */
        function countDefaultParams(params) {
            return params.filter(isDefaultParam).length;
        }
        ...
        return {
            ...
            onCodePathEnd(codePath, node) {
                ...
                // If it's a function, subtract complexity due to default parameters
                if (node.params) {
                    const defaultParamComplexity = countDefaultParams(node.params);
                    adjustedComplexity -= defaultParamComplexity;
                }

                if (adjustedComplexity > threshold) {
                    let name;
